app.controller('userTaskDetailCtrl', function($scope, $location, $modal, adminuserService, taskService, taskFactory, $window, $rootScope, $auth) {
    $scope.profile = $rootScope.currentAdmin;
    $scope.users = adminuserService;
    console.log(adminuserService);
    taskFactory.getUserTaskDetail(adminuserService.selectedUser)
