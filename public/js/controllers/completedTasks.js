app.controller('completedTaskCtrl', function($scope, $location, $modal, taskService, taskFactory, $window, $rootScope, $auth) {
    $scope.profile = $rootScope.currentUser;
    taskFactory.getCompletedTasks($scope.profile)
